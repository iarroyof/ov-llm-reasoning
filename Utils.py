...
def aleatorizarData(train_df, test_df):
    ...
    train_df = shuffle(train_df, random_state = 42)     # Orignialmete tenia 42 pero con 200k de entrenamiento de conecptnet arroga un error entonces se cambia a 40
    test_df = shuffle(test_df, random_state = 42)       # Orignialmete tenia 42 pero con 200k de entrenamiento de conecptnet arroga un error entonces se cambia a 40
